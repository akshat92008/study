...
export const PLAN_LIMITS: Record<SubscriptionTier, PlanLimits> = {
  free: {
    ...
    dailyAiCalls: 100,
    dailyAutopsyReports: 10,
    dailyAutopsyUploads: 10,
    dailyRagUploads: 50,
    dailyMaterialQueries: 100,
    dailyHermesWrites: 100,
    dailyRevisionGenerations: 20,
    maxMaterials: 500,
    maxAssessments: 200,
    maxFileMb: 50,
    monthlyAiBudgetUsd: 1,
  },
  founding: {
    ...
    dailyRagUploads: 100,
    dailyMaterialQueries: 200,
    dailyHermesWrites: 200,
    dailyRevisionGenerations: 50,
    maxMaterials: 1000,
    maxAssessments: 200,
    maxFileMb: 100,
    monthlyAiBudgetUsd: 15,
  },
  pro: {
    dailyChatMessages: 800,
    dailyAiCalls: 500,
    dailyAutopsyReports: 40,
    dailyAutopsyUploads: 40,
    dailyRagUploads: 200,
    dailyMaterialQueries: 500,
    dailyHermesWrites: 400,
