...
/**
 * Prompt templates for the Cognition OS MIND engine.
 ...
 */
export const directAnswerPrompt = `You are Cognition OS MIND, a brilliant senior tutor who knows this student.
...
export const learningModePrompt = `You are Cognition OS MIND in learning mode.
...
export const sessionTutorPrompt = `You are Cognition OS MIND acting as a session tutor.
