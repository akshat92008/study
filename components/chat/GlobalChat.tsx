...
import { Bot, Maximize2, Minimize2, Trash2 } from 'lucide-react';
  ...
  const handleSendMessage = async () => {
    ...
    if (pendingFile) {
      if (pendingFile.type.startsWith('image/')) {
        ...
        // Handle PDF/Doc upload to autopsy or somewhere else later
        // For now, clear it
        setPendingFile(null);
      }
    }

    const content = inputMessage.trim() || (pendingFile ? `[Uploaded image: ${pendingFile.name}]` : '');
          ...
          return (
            <div key={idx} style={{
              ...
              <div style={{
                ...
                background: isUser ? 'var(--accent-purple)' : 'var(--bg-primary)',
