...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-white/[0.04] py-16 text-center text-sm text-neutral-500 bg-[#000000] w-full flex justify-center">
      <div className="w-full max-w-5xl px-6 lg:px-8 flex flex-col items-center gap-8 relative z-10">
