...
export async function GET(req: NextRequest) {
  ...
  const [pending, processing, failed, dlq, consumerLag, autopsyPending, autopsyProcessing, autopsyFailed] = await Promise.all([
  ...
  const errors = [pending.error, processing.error, failed.error, dlq.error, consumerLag.error, autopsyPending.error, autopsyProcessing.error, autopsyFailed.error]
    .filter(Boolean)
